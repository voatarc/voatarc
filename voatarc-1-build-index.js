...
{
	submission_index_page_urls.push('https://voat.co/v/' + subverse_name + '/top?page=' + page_number);
	submission_index_page_urls.push('https://voat.co/v/' + subverse_name + '/hot?page=' + page_number);
	submission_index_page_urls.push('https://voat.co/v/' + subverse_name + '/new?page=' + page_number);
}
